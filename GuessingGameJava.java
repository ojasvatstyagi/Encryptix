...
public class GuessingGameJava implements ActionListener, KeyListener {
       ...
       int attemptCount =0, scoreCount=0, elapsedTime=0, minutes=0, seconds=0, temp=0;
       ...
       JLabel textLabel1, textLabel2, textLabel3, textLabel4, textLabel5, imageLabel, attemptsLabel, highestScoreLabel, timeTakenLabel; 
       JTextField guessTextField, attemptsField, highestScoreField, timeTakenField;
       ...
       textLabel3.setForeground(new Color(193, 140, 93));
       ...
       textLabel4.setForeground(new Color(73, 88, 103));
       ...
       guessButton.setBackground(new Color(193, 140, 93));
       ...
       giveUpButton.setBackground(new Color(193, 140, 93));
       ...
       newGameButton.setBackground(new Color(193, 140, 93));
       ...
       ImageIcon imageIcon = new ImageIcon("guess.png"); // load the image to a imageIcon
